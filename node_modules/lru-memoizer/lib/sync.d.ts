...
export type SyncParams3<T1, T2, T3, TResult> = IParamsBase3<T1, T2, T3, TResult> & {
    load: IMemoizableFunctionSync3<T1, T2, T3, TResult>;
};
export type SyncParams4<T1, T2, T3, T4, TResult> = IParamsBase4<T1, T2, T3, T4, TResult> & {
    load: IMemoizableFunctionSync4<T1, T2, T3, T4, TResult>;
};
export type SyncParams5<T1, T2, T3, T4, T5, TResult> = IParamsBase5<T1, T2, T3, T4, T5, TResult> & {
    load: IMemoizableFunctionSync5<T1, T2, T3, T4, T5, TResult>;
};
export type SyncParams6<T1, T2, T3, T4, T5, T6, TResult> = IParamsBase6<T1, T2, T3, T4, T5, T6, TResult> & {
