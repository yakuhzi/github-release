...
function validateAllParameterExposures(parameters) {
...
function validateExperimentExposurePercent(parameterValue, parameterName) {
    ...
    if (!validator.isNonNullObject(parameterValue) ||
        !validator.isNonNullObject(parameterValue.experimentValue)) {
        return;
    }
    const exposurePercent = parameterValue.experimentValue.exposurePercent;
