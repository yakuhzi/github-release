...
exports.ObjectValueFieldPath = exports.FieldPath = exports.QualifiedResourcePath = exports.ResourcePath = exports.DEFAULT_DATABASE_ID = void 0;
...
class FieldPath extends Path {
     ...
     * @internal
     */
    static _DOCUMENT_ID = new FieldPath('__name__');
    /**
     * @private
     * @internal
    ...
    constructor(...segments) {
        ...
        super(segments);
        (0, validate_1.validateMinNumberOfArguments)('FieldPath', segments, this._minNumSegments);
    }
    /**
 ...
 * @class
 */
class ObjectValueFieldPath extends FieldPath {
    /**
...
exports.ObjectValueFieldPath = ObjectValueFieldPath;
/**
...
function validateFieldPath(arg, fieldPath) {
    ...
    if (fieldPath === undefined) {
        throw new Error((0, validate_1.invalidArgumentMessage)(arg, 'field path') +
