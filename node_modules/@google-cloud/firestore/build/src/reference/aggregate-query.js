...
class AggregateQuery {
     ...
     */
    _pipeline() {
        const aggregates = (0, util_1.mapToArray)(this._aggregates, (aggregate, clientAlias) => {
            if (aggregate.aggregateType === 'count') {
                if (aggregate._field === undefined) {
                    return (0, pipelines_1.countAll)().as(clientAlias);
                }
                return (0, pipelines_1.count)((0, pipelines_1.field)(aggregate._field)).as(clientAlias);
            }
            else if (aggregate.aggregateType === 'avg') {
                return (0, pipelines_1.average)((0, pipelines_1.field)(aggregate._field)).as(clientAlias);
            }
            else if (aggregate.aggregateType === 'sum') {
                return (0, pipelines_1.sum)((0, pipelines_1.field)(aggregate._field)).as(clientAlias);
            }
            else {
