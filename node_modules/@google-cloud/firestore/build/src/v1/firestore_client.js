...
class FirestoreClient {
    ...
    initialize() {
        ...
        const clientOpts = Object.assign({}, this._opts);
        ...
        this.firestoreStub = this._gaxGrpc.createStub(clientOpts.fallback
            ? this._protos.lookupService('google.firestore.v1.Firestore')
            : this._protos.google.firestore.v1.Firestore, clientOpts, this._providedCustomServicePath);
